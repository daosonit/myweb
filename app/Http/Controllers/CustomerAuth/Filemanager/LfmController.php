...
class LfmController extends Controller
{
     ...
     * @var
     */
    public $file_location = null; //Đường dẫn file
    public $dir_location  = null; //
    public $file_type     = null; //Kiểu file
    ...
    {
        $this->file_type = Request::input('type', 'Images');
    ...
    public function show()
    {
        ...
        return view('customer.filemanager.index')->with('working_dir', $working_dir)
